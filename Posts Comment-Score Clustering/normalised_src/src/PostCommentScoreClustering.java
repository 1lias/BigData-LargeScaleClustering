   ...
   public static void runJob(String[] input, String output) throws Exception {
     ...
     while(!clustered){
       ...
       if(iteration == 0){
         ...
         oldCentroids.add(new DoubleDoublePair(0.001,0.1));
         oldCentroids.add(new DoubleDoublePair(0.29,0.5));
...
/*
         ...
         conf.set("C1", "0.02504257115732856\t5.79828251877422E-4");
         conf.set("C2", "0.03486119290700805\t0.037594630651717066");
         conf.set("C3", "0.11054113465175787\t0.20490014262346093");
